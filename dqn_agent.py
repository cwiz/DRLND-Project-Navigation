...
class Agent():
    ...
    def __init__(self, state_size, action_size, seed, flavor="vanilla"):
    ...
    def learn(self, experiences, gamma):
        ...
        # Q_targets_next_arg = self.qnetwork_target.forward(next_states).detach().argmax(1)[0] #max(1)[0].unsqueeze(1)
